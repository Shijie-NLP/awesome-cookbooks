        ...
        try:
            messages = (
                [
                    {
                        "role": "system",
                        "content": getFinalSystemPrompt(aggregator_system_prompt, prev_response),
                    },
...
async def main():
    ...
    for _ in range(1, layers - 1):
        results = await asyncio.gather(*[run_llm(model, prev_response=results) for model in reference_models])
